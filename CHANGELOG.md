...
- Create Angular project with ng: `ng new bazneshastegi.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bazneshastegi.client.esproj`).
