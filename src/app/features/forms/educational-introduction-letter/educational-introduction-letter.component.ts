...
import {EducationalIntroductionLetterRequest} from './educational-introduction-letter.model';

@Component({
  selector: 'app-educational-introduction-letter',
  templateUrl: './educational-introduction-letter.component.html',
  styleUrl: '../forms.scss',
  standalone: false
})
export class EducationalIntroductionLetterComponent extends BaseFormComponent implements OnInit {
  constructor() {
    super();
    this.getRelations();
  }
  ...
  submit() {
    ...
    if (this.form.valid && !this.relatedPersonIDError) {
      const request: EducationalIntroductionLetterRequest = this.form.getRawValue();
